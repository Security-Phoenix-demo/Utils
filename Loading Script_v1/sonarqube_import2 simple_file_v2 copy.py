...
# Import parameters
FILE_PATH = 'YOURFILE.json' #file to load
SCAN_TYPE = 'SCANNERNAME' #scanner name
ASSESSMENT_NAME = 'YOURASSESSMENTNAME' #assessment name
IMPORT_TYPE = 'new' #new or delta
SCAN_TARGET = 'YOURSCANTARGET' #target to scan
AUTO_IMPORT = True #auto import
WAIT_FOR_COMPLETION = True #wait for completion

# Scanner types file path
SCANNER_TYPES_FILE = 'Scanner_Selection.txt'
