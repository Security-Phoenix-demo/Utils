...
```json
{
  "message": "Athena WorkGroup example-workgroup does not encrypt the query results.",
  "severity": "Medium",
  "severity_id": 3,
  "status_code": "FAIL",
  "finding_info": {
    ...
    "uid": "prowler-aws-athena_workgroup_encryption-100000000001-us-east-1-example-workgroup"
  },
  "cloud": {
    "provider": "aws",
    "region": "us-east-1",
...
[
  ...
  {"key": "account_id", "value": "100000000001"},
  {"key": "imported", "value": "2025-11-11"},
  {"key": "eks:cluster-name", "value": "example-eks-cluster"}  // from resource labels
]
```
