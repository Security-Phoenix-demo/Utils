"""
Final Two Translators - MS Defender and ORT
============================================

Dedicated translators for the last 2 scanners to reach 99% coverage.
"""
...
class ORTTranslator(ScannerTranslator):
    ...
    def parse_file(self, file_path: str) -> List[AssetData]:
        ...
        try:
            ...
            for issue in issues:
                ...
                package_issues[pkg_id].append(VulnerabilityData(
            ...
            for idx, package in enumerate(packages):
                ...
                if not pkg_issues:
                    pkg_issues = [VulnerabilityData(
                        name="NO_ISSUES_FOUND",
                        description="No issues found for this package",
                        remedy="No action required",
                        severity="0.0",
                        location=package_id
                    )]
            ...
            if not packages and issues:
                asset = AssetData(
                    ...
                    findings=package_issues.get(0, [VulnerabilityData(
                        name="ORT_ANALYSIS",
                        description="ORT analysis completed",
                        remedy="Review findings",
                        severity="5.0",
                        location="ORT"
                    )]),
                    tags=tags
    ...
    def _map_ort_severity(self, severity: str) -> str:
        """Map ORT severity to Phoenix decimal"""
        mapping = {
            'error': '8.0',
            'warning': '5.0',
            'hint': '3.0',
