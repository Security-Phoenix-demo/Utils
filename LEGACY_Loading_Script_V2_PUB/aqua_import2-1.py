...
send_results('aqua_example2.json', 'Aqua Scan', 'Container_pipeline_assesm7', 'new', client_id, client_secret, "TST.wpay.com/POC1_CD_wpay_app_backend:latest")
send_results('aqua_example2.json', 'Aqua Scan', 'Container_pipeline_assesm8', 'new', client_id, client_secret, "TST.wpay.com/POC1_CD_wpay_app_backend:3_2")
send_results('aqua_example2.json', 'Aqua Scan', 'Container_pipeline_assesm9', 'new', client_id, client_secret, "TST.wpay.com/POC1_CD_wpay_app_backend:3_1")
send_results('aqua_example2.json', 'Aqua Scan', 'Container_pipeline_assesm10', 'new', client_id, client_secret, "TST.wpay.com/POC1_CD_wpay_app_backend:3_3")
send_results('aqua_example2.json', 'Aqua Scan', 'Container_pipeline_assesm11', 'new', client_id, client_secret, "TST.wpay.com/POC1_CD_wpay_app_backend:3_0")
